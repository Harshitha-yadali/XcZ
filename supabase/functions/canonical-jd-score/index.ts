...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const canonicalResume = JSON.stringify(normalizeForHash(body.resumeData));
    ...
    if (!scoreResult) {
      ...
      scoreResult = scoreResumeAgainstJD(body.resumeData, body.jobDescription, body.candidateType as UserType);
